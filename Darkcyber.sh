...
pu='\033[37;1m' #putih
ku='\033[33;1m' #kuning
# [SUBSCRIBE] Last Pro Editor
figlet -f standard FB Tools | lolcat
echo
echo  " ____________________-=[Private Tools]=-____________________" | lolcat
echo  "|                                                           |" | lolcat
echo  "|              Root®Autor      : Dr.Cyber01                 |" | lolcat
echo  "|              Youtube         : DarkCyber01                |" | lolcat
echo  "|              Thanks to       : FRIEND$                    |" | lolcat
...
echo $i"========================================"
echo
echo $me"┌==="$bi"["$i"Dr.cyber"$bi"]"$me"======"$bi"["$i""Masukan Nomor""$bi"]"
echo $me"¦"
read -p"└──# " pil
...
sleep 2
echo $cy"Gunakan Tools Dengan Bijak"
sleep 2
echo $i"Jangan lupa Bahagia"
sleep 2
echo $ku"Youtube :"$i" Dr.CyberTeam"
echo $ku"Facebook :"$i" Rangga01"
echo $ku"Instagram :"$i" Dr.cyber01"
sleep 2
echo $pur" Contac 085294116311"
exit
fi
